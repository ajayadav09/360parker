...
var backgroundSlideOpacity = 1.0; 
var currentSlideHeight = 200;
var backgroundSlideHeight = 150;
var currentSlideWidth = 200;
var backgroundSlideWidth = 150;
var currentSlideTop = -27;
var backgroundSlideTop = 40;
...
function moveLeft() {
  ...
  $('#gallery').animate( { left: '+=' +offset } );
   ...
   slides[currentSlide].animate( { height: backgroundSlideHeight,
                                    width: backgroundSlideWidth,
									 top: backgroundSlideTop     },500 );
  slides[currentSlide-1].animate( { height: currentSlideHeight,
                                     width: currentSlideWidth,
									 top: currentSlideTop      },500);
...
function centreCurrentSlide() {
  ...
  var offsetFromGalleryStart;

  for ( var i=0; i <= currentSlide; i++ ) {
    offsetFromGalleryStart = offsetFromGalleryStart + slideWidths[i] + slideHorizMargin*2;
  }
